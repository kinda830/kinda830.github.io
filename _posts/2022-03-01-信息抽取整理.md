...
![Untitled](../images/information extract/Untitled.png)
...
![Untitled](../images/information extract/Untitled%201.png)
...
![Untitled](../images/information extract/Untitled%202.png)

这部分的优化目标是：

![Untitled](../images/information extract/Untitled%203.png)
...
![Untitled](../images/information extract/Untitled%204.png)
...
![Untitled](../images/information extract/Untitled%205.png)

这一模块的优化函数为：

![Untitled](../images/information extract/Untitled%206.png)
...
![Untitled](../images/information extract/Untitled%207.png)

如上图所示，共有三种握手标记：

1. 紫色代表两实体的头尾握手，即表示一个实体的头尾索引位置；
   
    ![Untitled](../images/information extract/Untitled%208.png)
    
    如上图所示，上面矩阵中两个 1 标识即表示 New York City 和 De Blasio 两个实体；
    
2. 红色代表某个关系下两个实体头的握手；
   
    ![Untitled](../images/information extract/Untitled%209.png)
    
    如上图所示，上面矩阵中的 1 表示某个关系下的两个实体头的索引位置，即 New York City 和 De Blasio 的实体头索引位置；
    
3. 蓝色代表某个关系下两个实体尾的握手；
   
    ![Untitled](../images/information extract/Untitled%2010.png)
...
![Untitled](../images/information extract/Untitled%2011.png)

### 1.2.2. 模型结构

模型结构比较简单，具体如下图所示：

![Untitled](../images/information extract/Untitled%2012.png)
...
2. encoder
    ...
    2. 然后采用 h_i,j 作为一个 token pair 的向量表示，然后采用以下公式进行计算，得到 token pair 的向量表示：
        ...
        ![Untitled](../images/information extract/Untitled%2013.png)
...
3. Handshaking Kernel
    ...
    ![Untitled](../images/information extract/Untitled%2014.png)
    
4. decoding
   
    解码算法的伪代码如下：
    
    ![Untitled](../images/information extract/Untitled%2015.png)
    
5. loss function
   损失函数公式如下：
   
    ![Untitled](../images/information extract/Untitled%2016.png)
...
2. 打分部分
    ...
    ![Untitled](../images/information extract/Untitled%2017.png)
    
    上面代表第 a 中类型实体所用的向量序列，那么打分公式如下：
    
    ![Untitled](../images/information extract/Untitled%2018.png)
...
3. 引入相对位置
    ...
    ![Untitled](../images/information extract/Untitled%2019.png)
...
1. 内存优化
    ...
    2. 分类：采用 特征拼接 + Dense层 来完成，即新的打分函数如下：
        ...
        ![Untitled](../images/information extract/Untitled%2020.png)
...
![Untitled](../images/information extract/Untitled%2021.png)
...
![Untitled](../images/information extract/Untitled%2022.png)
...
![Untitled](../images/information extract/Untitled%2023.png)

这里作者为来提高训练速度，实现了一个稀疏版的多标签交叉熵：

![Untitled](../images/information extract/Untitled%2024.png)
